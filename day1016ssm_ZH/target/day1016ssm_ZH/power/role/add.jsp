...
<table border="1" width="100%" class="table_a">
                <tr  width="120px;">
                    ...
                    <td>
						<input type="text"  name="rolename" value="管理员" /><span></span>
					</td>
                </tr>
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<ul>
                        	...
                        	<li><input type="checkbox" id="m${menu.menuid}" onclick="checksecond(${menu.menuid})" name="menu"  value="${menu.menuid}"/>${menu.menuname}
                            	<ul>
                                    <c:forEach items="${menu.seconds}" var="menu2">
                                	<li>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="a${menu.menuid}" onclick="gettop(${menu.menuid})" value="${menu2.menuid}" name="menu"  />${menu2.menuname}</li>
                                    </c:forEach>
                                </ul>
                            </li>
                            </c:forEach>
