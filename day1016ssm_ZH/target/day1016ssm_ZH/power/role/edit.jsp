                ...
                <tr  width="120px;">
                    ...
                    <td>
						<ul>
                        	...
                        	<li><input type="checkbox" name="menu" value="${menu1.menuid}"
                                    <c:forEach items="${role.menus}" var="mymenus">
                                        <c:if test="${mymenus.menuid==menu1.menuid}">checked</c:if>
                                    </c:forEach> />${menu1.menuname}
                            	<ul>
                                    <c:forEach items="${menu1.seconds}" var="menu2">
                                	<li>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu" value="${menu2.menuid}"
                                            <c:forEach items="${role.menus}" var="mymenus">
                                                <c:if test="${mymenus.menuid==menu2.menuid}">checked</c:if>
