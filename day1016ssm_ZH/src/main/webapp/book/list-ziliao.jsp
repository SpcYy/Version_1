...
<body>
	...
	<div class="div_head" style="width: 100%;text-align:center;">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                	<a style="text-decoration: none" href="/book/getInfo">【上传】</a> &emsp;
    ...
    <div class="fllist">
        <ul>
            ...
            <li><strong>类型：</strong><a href="/book/getlistziliao" id="tAll" >全部</a>
                
                <a href="/book/getlistbytypeid?typeid=1" id="1" >
                    复习资料</a>
                
                <a href="/book/getlistbytypeid?typeid=2" id="2" >
                    练习题</a>
        ...
        <div class="cztable">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                ...
                <c:forEach items="${pi.list}" var="in">
                    <tr>
                        <td>
                        <c:if test="${in.format.formatid==1}">
                        <img src='../Images/FileIco/doc.gif' />
                        </c:if>
                        <c:if test="${in.format.formatid==2}">
                        ...
                        <td>
                           <fmt:formatDate value="${in.date}" pattern="yyyy-MM-dd"/>
                        </td>
                        <td>
                ...
                <tr>
                    <td colspan="20" style="text-align: center;">
                        ...
                        <fy:fy url="/book/getlistziliao?informationname=${informationname}"
                               pageInfo="${pi}"></fy:fy>
                        每页显示
                        <select name="num">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $("[name=num]").change(function () {
                                var size=$(this).val();
                                location.href="/book/getlistziliao?size="+size;
                            })
                        });
                    </script>
                </tr>
