        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr align="center">
                    ...
                    <td>&nbsp;
                    	<a href="javascript:alert('操作成功！');">${r.rolestate==1?"启用":"禁用"}</a>
                        <a href="info.html">详情</a>						   
                        <a href="/power/role/findbyid?rid=${r.roleid}">修改</a>
...
<div class='MainStyle'>
    <fy:fy url="/power/role/getroles?roleid=" pageInfo="${rpage}"></fy:fy>
</div>
    </div>
</body>
</html>